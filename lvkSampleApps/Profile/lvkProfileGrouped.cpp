    ...
    virtual void Loop() override
    {
        ...
        if(ResourcesLoaded())
        {
            ...
            
            {
                ...
                TestRenderer.BindMeshGroup(CommandBuffer,MeshGroup2Data);
                TestRenderer.BindImageGroup(CommandBuffer,ImageGroup2Data);
                ...
                for(const auto &MeshInstance : MeshInstances)
                {
                    ...
                    for(int k = 0;k < MeshGroup2Data.MeshGroup.Meshes[MeshInstance.MeshId].IndexedSubMeshCount;k++)
                    {
